...
const blogPosts = [
  {
    id: 1,
    title: 'Boost your AI modeling time',
    href: '#',
    date: 'Mar 16, 2020',
    datetime: '2020-03-16',
          ...
          <div className="relative">
            ...
            <Popover as="header" className="relative">
                ...
                >
                  <div className="flex flex-1 items-center">
                    <div className="flex w-full items-center justify-between md:w-auto">
                      <a href="#">
                        <span className="sr-only">VeinBrains</span>
                        <img
              ...
              >
                <Popover.Panel
                  focus
                  className="absolute inset-x-0 top-0 origin-top p-2 transition md:hidden"
                >
            ...
            <div className="relative bg-transparent pt-10 sm:pt-16 lg:overflow-hidden lg:pt-8 lg:pb-14">
                          ...
                          <div className="sm:flex">
                            <div className="min-w-0 flex-1">
                              ...
                              <input
                                ...
                                className="block w-full rounded-md border-0 px-4 py-3 text-base text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-900"
                              />
                            </div>
          ...
          <div className="mx-auto max-w-md px-4 pt-12 sm:max-w-7xl sm:px-6 lg:px-8 lg:pt-16">
            ...
            <div className="mt-12 border-t border-gray-200 py-8">
              <p className="text-base text-gray-400 xl:text-center">
                &copy; 2020 VeinBrains DAO. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
